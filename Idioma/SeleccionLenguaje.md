...
* Proyectos personales: suelen orientarse a aprendizaje propio, como la comunicación de un integrado con el microcontrolador, el uso de un nuevo periférico, entre otros; por lo cual, no hay una repercusión real en la selección de un lenguaje. Aquí, la selección de la forma de escritura del programa la hace uno mismo. 
* Proyectos escolares: están orientados al desarrollo de trabajos para materias, por lo cual es más relevante la implementación misma que la forma de redacción del programa, por lo cual la selección del lenguaje suele quedar a consideración por los integrantes del equipo.
*  Proyectos comerciales y de investigación: suelen ser proyectos orientados a ofrecer un producto, servicio o investigación, de modo que suelen ser equipos grandes con integrantes provenientes de cualquier lugar del mundo. Esto provoca que la selección del lenguaje sea algo que si influye en el desarrollo del proyecto.
